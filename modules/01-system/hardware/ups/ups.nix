{...}: let
  ...
  productid = "5161";
  upsName = "UPS-1";
  upsPasswordFile = "/home/nea/ups.txt";
in {
  services.udev.extraRules = ''
    SUBSYSTEM=="usb", ATTR{idVendor}=="${vendorid}", ATTR{idProduct}=="${productid}", MODE="0660", GROUP="nut"
  '';
  ...
  power.ups = {
    ...
    ups."${upsName}" = {
      ...
      directives = [
        ...
        # "lowbatt = 30" # seems only for usbhid-ups
